export default {
  ...
  "Animator image": "Slika napovedovalca {name}",
  Emission: "Oddaja",
  ...
  "Evening":"Večer",
  "Now":"Zdaj",
  "Number comments": "{nb} komentarjev",
  "Like": "Všeč mi je",
  "Dislike": "Ni mi všeč",
  "Welcome, thanks for your interaction": "Dobrodošli, hvala za vašo interakcijo",
  "Report abuse": "Prijavi zlorabo",
  "Send": "Pošlji",
  "Describe the reason for the report": "Opišite razlog za prijavo",
  "Thank you for reporting abuse": "Hvala, ker ste prijavili zlorabo",
  "abuse denounced": "{nb} prijavljena(-e) zloraba(-e)",
  "nb answers": "{nb} odgovorov",
  "Edit comment": "Uredi komentar",
  "Comment": "Komentar",
  "Please provide a comment": "Prosim, vnesite komentar",
  "Pick your emoji": "Izberite svoj emoji",
  "Comment information": "Informacije o komentarju",
