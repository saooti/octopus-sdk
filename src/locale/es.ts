export default {
  ...
  "No podcast match your query": "Tu búsqueda no ha dado resultados",
  ...
  "More episodes of this category : {name}":
    "Más episodios de esta categoría: {name}",
  ...
  "This episode is not available for (re)listening":
    "Ese pódcast no está disponible para (re)escuchar",
  ...
  "Participant have not podcasts": "No hay pódcast para este participante",
  ...
  "A live can start any moment":
    "Una retransmisión en directo podría comenzar en breves instantes",
  "Recorded in live": "Grabación en directo",
  "Podcast linked to waiting live":
    "Pódcast pendiente de una próxima retransmisión en directo",
  ...
  "Display all podcasts to validate":
    "Mostrar todos los pódcast pendientes de validación",
  "Display my podcasts to validate":
    "Mostrar mis pódcast pendientes de validación",
  ...
  "Add a sort criterion by topic":
    "Añadir un criterio de clasificación por tema",
  ...
  "Evening":"Noche",
  "Now":"Ahora",
  "Number comments": "{nb} comentarios",
  "Like": "Me gusta",
  "Dislike": "No me gusta",
  "Welcome, thanks for your interaction": "Bienvenido, gracias por tu interacción",
  "Report abuse": "Denunciar abuso",
  "Send": "Enviar",
  "Describe the reason for the report": "Describe la razón de la denuncia",
  "Thank you for reporting abuse": "Gracias por denunciar el abuso",
  "abuse denounced": "{nb} abuso(s) denunciado(s)",
  "nb answers": "{nb} respuestas",
  "Edit comment": "Editar comentario",
  "Comment": "Comentario",
  "Please provide a comment": "Por favor, ingrese un comentario",
  "Pick your emoji": "Elige tu emoji",
  "Comment information": "Información sobre los comentarios",
  ...
  "Episode page":"Página del episodio",
  "Comments":"Comentarios",
  "Information":"Información",
  "The episode does not have an associated video":"El episodio no tiene un vídeo asociado",
  ...
  "Organisation name image": "Imagen de la organización {name}",
  "Series name page": "Página del programa \"{name}\"",
  "Episode name page": "Página del episodio \"{name}\"",
  "Radio name page": "Página de la radio \"{name}\"",
