export default{
  ...
  "Evening":"Sera",
  "Now":"Ora",
  "Number comments": "{nb} commenti",
  "Like": "Mi piace",
  "Dislike": "Non mi piace",
  "Welcome, thanks for your interaction": "Benvenuto, grazie per la tua interazione",
  "Report abuse": "Segnala abuso",
  "Send": "Invia",
  "Describe the reason for the report": "Descrivi il motivo della segnalazione",
  "Thank you for reporting abuse": "Grazie per aver segnalato l'abuso",
  "abuse denounced": "{nb} abuso(i) segnalato(i)",
  "nb answers": "{nb} risposte",
  "Edit comment": "Modifica commento",
  "Comment": "Commento",
  "Please provide a comment": "Per favore inserisci un commento",
  "Pick your emoji": "Scegli il tuo emoji",
  "Comment information": "Informazioni sui commenti",
  "Delete comment": "Cancella commento",
  "Confirm comment deletion text":
    "Sei sicuro di voler eliminare il commento di {name}?",
  "Update comment": "Aggiorna commento",
  "Managing reported abuses":"Gestione degli abusi segnalati",
  "Sort by":"Ordina per",
  ...
  "Apple podcast": "Podcast Apple / iTunes",
  Deezer: "Deezer",
  Spotify: "Spotify",
  Tunein: "Tunein",
  Radioline: "Radioline",
